...
class Train(object):
    ...
    def train(self):
        ...
        # Initial a saver to save checkpoints.
        ...
        for step in range(FLAGS.train_steps):
                ...
                if FLAGS.is_full_validation is True:
                    ...
                    _, validation_error_value, validation_loss_value = sess.run(
                        ...
                        feed_dict={
                            ...
                            self.lr_placeholder: FLAGS.init_learning_rate
                        }
                    )
            ...
            if step == FLAGS.decay_step0 or step == FLAGS.decay_step1:
                FLAGS.init_learning_rate = 0.1 * FLAGS.init_learning_rate
                print('Learning rate decayed to ', FLAGS.init_learning_rate)
    ...
    def train_operation(self, global_step, total_loss, top1_error):
        ...
        # ema helps calculate the moving average of train loss and train error
    ...
    def validation_op(validation_step, top1_error, loss):
        # ema helps calculate the moving average of validation loss and train error
